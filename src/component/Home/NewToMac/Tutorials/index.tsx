  ...
  return (
    <TutorialsStyle transform={0}>
      <div>
        ...
        />
        <p>
          <span>Mac + iPhone.</span> Mac is designed to be just as easy to learn
          as iPhone. And whether you’re chatting with friends in Messages,
          transferring files with AirDrop, or locating devices with Find My —
          when you use Mac with iPhone, they work even better together.
        </p>
      </div>
      <div>
        <img
      ...
      <div>
        ...
        />
        <p>
          <span>Migration Assistant.</span> Easily move files, apps, and more
          from your old PC or Mac. And if you need any help, Apple Support is
          always just an online chat, phone call, or in-store appointment away.
        </p>
      </div>
      <div>
        <img
      ...
      <div>
        ...
        <p>
          <span>Yep, Mac does that.</span> It’s not just MacBook Air. Every Mac
          is designed to be this easy, powerful, and amazing.
        </p>
        <p>Learn more</p>
      </div>
    </TutorialsStyle>
