...
export default function Tutorials({
  ...
  return (
    <TutorialsStyle padding={padding}>
      <div>
        <div>
          <img
          ...
          <p>
            ...
            Messages, transferring files with AirDrop, or locating devices with
            Find My — when you use Mac with iPhone, they work even better
            together.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            ...
            always just an online chat, phone call, or in-store appointment
            away.
          </p>
        </div>
        <div>
